...
int main(void)
{
	...
	KEY_BSP_Init();
	bldc0_system_init();
	printf("BLDC with hall test begins.\n\r");	
	LED0(1);
	LED1(1);
	while(1)
	{
		...
		{
			bldc0_reverse();
			if(BLDC0.direction.dir_target == MOTOR_FWD)
			{
				printf("BLDC operates backwards.\n\r");
			}
			else
			{
				printf("BLDC operates forwards.\n\r");			
			}	
			Key_Value = 4;	
		}	
