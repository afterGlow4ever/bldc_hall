...
#define BLDC0_HALL_TIM           				  TIM5
#define BLDC0_HALL_TIM_CLK_ENABLE()  			__TIM5_CLK_ENABLE()

// int after TIM_Period
// a period is 0~9999
#define BLDC0_HALL_PERIOD_COUNT     			(10000)

// TIMxCLK=2*PCLK1  
// PCLK1=HCLK/2
// TIMxCLK=HCLK/2=SystemCoreClock/2=200MHz
// set TIMxCLK/(BLDC0_HALL_PERIOD_COUNT)/BLDC0_HALL_PRESCALER_COUNT=10Hz
// period 10Hz 100ms
#define BLDC0_HALL_PRESCALER_COUNT     		(2000)

// u
#define BLDC0_HALL_U_PIN           		    GPIO_PIN_10
#define BLDC0_HALL_U_GPIO_PORT     		    GPIOH
#define BLDC0_HALL_U_GPIO_CLK_ENABLE() 	  __GPIOH_CLK_ENABLE()
#define BLDC0_HALL_U_AF					          GPIO_AF2_TIM5

// v
#define BLDC0_HALL_V_PIN           		    GPIO_PIN_11
#define BLDC0_HALL_V_GPIO_PORT     		    GPIOH
#define BLDC0_HALL_V_GPIO_CLK_ENABLE() 	  __GPIOH_CLK_ENABLE()
#define BLDC0_HALL_V_AF					          GPIO_AF2_TIM5

// w
#define BLDC0_HALL_W_PIN           		    GPIO_PIN_12
#define BLDC0_HALL_W_GPIO_PORT     		    GPIOH
#define BLDC0_HALL_W_GPIO_CLK_ENABLE() 	  __GPIOH_CLK_ENABLE()
#define BLDC0_HALL_W_AF					          GPIO_AF2_TIM5

#define BLDC0_HALL_TIM_IRQn               TIM5_IRQn
#define BLDC0_HALL_TIM_IRQHandler         TIM5_IRQHandler
